package com.likelion.dermaday.common.response;
...
public enum SuccessStatus {
    ...
    PUSH_PREFERENCE_GET_SUCCESS(HttpStatus.OK, "푸시 알림 동의 조회 성공"),
    PUSH_PREFERENCE_UPDATE_SUCCESS(HttpStatus.OK, "푸시 알림 동의 변경 성공"),
    PUSH_INSTALLATION_REGISTER_SUCCESS(HttpStatus.OK, "푸시 수신 기기 등록 성공"),
    PUSH_INSTALLATION_DELETE_SUCCESS(HttpStatus.OK, "푸시 수신 기기 삭제 성공"),
